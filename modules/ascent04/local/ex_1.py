...
for k in range(2, 11):
    ...
    km = ____  # Hint: KMeans(n_clusters=k, random_state=42, n_init=10)
...
# TODO: Fit the final K-means model using best_k
...
# Spectral clustering (Spectral is O(n³), sample for speed)
n_spectral = best_k
# TODO: Create SpectralClustering and predict on first 10K rows
spectral = ____  # Hint: SpectralClustering(n_clusters=n_spectral, random_state=42, affinity="rbf")
spectral_labels = ____  # Hint: spectral.fit_predict(X_scaled[:10_000])

# HDBSCAN
if hdbscan is not None:
    # TODO: Create HDBSCAN and fit_predict on full X_scaled
...
# TODO: Create GMM, get hard labels and soft assignment probabilities
gmm = ____  # Hint: GaussianMixture(n_components=best_k, random_state=42, covariance_type="full")
...
for name, labels in all_labels.items():
    ...
    # TODO: Compute three clustering evaluation metrics
    results[name] = {
...
async def automl_comparison():
    ...
    # TODO: Create AutoMLConfig for clustering with silhouette metric,
    # maximize direction, random search strategy (20 trials), agent=False,
    ...
    config = AutoMLConfig(
        ...
        agent=____,  # Hint: False — double opt-in: set True + kailash-ml[agents]
...
# TODO: Add cluster label column using pl.Series
clustered = ____  # Hint: profiling_df.with_columns(pl.Series("cluster", best_labels))
...
# TODO: Build method comparison chart using viz.metric_comparison
fig = ____  # Hint: viz.metric_comparison(results)
...
# TODO: Build elbow curve using viz.training_history
fig_elbow = ____  # Hint: viz.training_history(elbow_data, x_label="K")
